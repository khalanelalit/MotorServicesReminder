        ...
        <table class="table">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col">GarageContact No</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td scope="row"><%= cp.getChassisNo() %></td>
                    <td scope="row"><%= cp.getName() %></td>
                   
                    <td scope="row"><%= cp.getContact() %></td>
                    <td scope="row"><%= cp.getOwnerName() %></td>
                ...
                <td> <a href="deletes/<%= cp.getVehicleNo()%>"><button type="button" class="btn btn-primary btn-sm">Delete</button></a> </td>
