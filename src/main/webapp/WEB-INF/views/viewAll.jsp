...
<%@ page import="com.lalit.Garages.Garages" %>
...
<div id="content">
    <div class="form-container">
        ...
        <table class="table">
            ...
            <tbody>
                <%
                    List<Garages> list = (List<Garages>) request.getAttribute("list");
                    for(Garages cp:list) {
                %>
                <tr>
                    <td scope="row"><%= cp.getContact() %></td>
                    <td scope="row"><%= cp.getName() %></td>
                    <td scope="row"><%= cp.getAddress() %></td>
                    <td scope="row"><%= cp.getPin() %></td>
                    <td scope="row"><%= cp.getEmail() %></td>
                     <td scope="row"><%= cp.getPassword() %></td>
                     
                     
                     
         <td> <a href="delete/<%= cp.getContact()%>"><button type="button" class="btn btn-primary btn-sm">Delete</button></a> </td>
